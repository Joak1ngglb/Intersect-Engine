...
namespace Intersect.Editor.Forms.Editors.Events
{
    partial class FrmEvent
    {
        ...
        private void InitializeComponent()
        {
            ...
            var treeNode70 = new TreeNode("SendMail");
            var treeNode71 = new TreeNode("Open Mail Box");
            var treeNode72 = new TreeNode("Mails", new TreeNode[] { treeNode70, treeNode71 });
            var treeNode73 = new TreeNode("Open Market");
            var treeNode74 = new TreeNode("Open Sell Market");
            var treeNode75 = new TreeNode("Market", new TreeNode[] { treeNode73, treeNode74 });
            var treeNode76 = new TreeNode("Open Enchant Window");
            var treeNode77 = new TreeNode("Open Mage Window");
            var treeNode78 = new TreeNode("Open Broke Items Window");
            var treeNode79 = new TreeNode("Upgrade", new TreeNode[] { treeNode76, treeNode77, treeNode78 });
            lblName = new Label();
            ...
            treeNode70.Name = "sendmail";
            treeNode70.Tag = "201";
            treeNode70.Text = "SendMail";
            treeNode71.Name = "openmailbox";
            treeNode71.Tag = "202";
            treeNode71.Text = "Open Mail Box";
            treeNode72.Name = "mails";
            treeNode72.Text = "Mails";
            treeNode73.Name = "openmarket";
            treeNode73.Tag = "203";
            treeNode73.Text = "Open Market";
            treeNode74.Name = "opensellmarket";
            treeNode74.Tag = "204";
            treeNode74.Text = "Open Sell Market";
            treeNode75.Name = "market";
            treeNode75.Text = "Market";
            treeNode76.Name = "openenchantwindow";
            treeNode76.Tag = "205";
            treeNode76.Text = "Open Enchant Window";
            treeNode77.Name = "openmagewindow";
            treeNode77.Tag = "206";
            treeNode77.Text = "Open Mage Window";
            treeNode78.Name = "openbrokewindow";
            treeNode78.Tag = "207";
            treeNode78.Text = "Open Broke Items Window";
            treeNode79.Name = "upgradeo";
            treeNode79.Text = "Upgrade";
            lstCommands.Nodes.AddRange(new TreeNode[] { treeNode5, treeNode13, treeNode33, treeNode43, treeNode52, treeNode56, treeNode58, treeNode62, treeNode67, treeNode69, treeNode72, treeNode75, treeNode79 });
