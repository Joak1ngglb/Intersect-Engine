...
Tick timer saved in server config.json.";
        ...
        internal static string requiredmaturity;
        internal static string requiredenergy;
        internal static string requiredmood;
        internal static string maxbreedcount;
    }
...
Tick timer saved in server config.json.";
        ...
        public static readonly Dictionary<JobType, LocalizedString> JobExperienceMessages = new Dictionary<JobType, LocalizedString>
    {
        ...
        { JobType.Weaver, "Give Player {00} Weaver Experience" }
    };
