...
partial class frmSets
{
    ...
    private void InitializeComponent()
    {
        ...
        nudMRPercentage = new DarkUI.Controls.DarkNumericUpDown();
        nudDefPercentage = new DarkUI.Controls.DarkNumericUpDown();
        nudMagPercentage = new DarkUI.Controls.DarkNumericUpDown();
        nudStrPercentage = new DarkUI.Controls.DarkNumericUpDown();
        nudARPPercentage = new DarkUI.Controls.DarkNumericUpDown();
        nudVitPercentage = new DarkUI.Controls.DarkNumericUpDown();
        nudWisPercentage = new DarkUI.Controls.DarkNumericUpDown();
        lblPlus8 = new Label();
        lblPlus7 = new Label();
        lblPlus6 = new Label();
        lblPlus5 = new Label();
    ...
    private DarkUI.Controls.DarkNumericUpDown nudMRPercentage;
    private DarkUI.Controls.DarkNumericUpDown nudDefPercentage;
    private DarkUI.Controls.DarkNumericUpDown nudMagPercentage;
    private DarkUI.Controls.DarkNumericUpDown nudStrPercentage;
    private DarkUI.Controls.DarkNumericUpDown nudARPPercentage;
    private DarkUI.Controls.DarkNumericUpDown nudVitPercentage;
    private DarkUI.Controls.DarkNumericUpDown nudWisPercentage;
